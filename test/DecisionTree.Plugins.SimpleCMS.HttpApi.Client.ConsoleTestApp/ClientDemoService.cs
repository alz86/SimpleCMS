...
public class ClientDemoService : ITransientDependency
{
    ...
    public ClientDemoService(
        IContentEntryAppService contentEntryAppService,
    ...
    private async Task TestWithDynamicProxiesAsync()
    {
        ...
        //var result = await _contentEntryAppService.GetAsync(SimpleCMSTestData.);
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:SimpleCMS:BaseUrl"] +
                      "api/SimpleCMS/sample/authorized";
